    ...
    return (
      ...
      >
        <header className={s.logo}>
          <a href="https://demo.flatlogic.com/light-blue-react/"> <span className="fw-bold">미래에셋 자산운용</span></a>
        </header>
        <ul className={s.nav}>
          <h5 className={[s.navTitle, s.groupTitle].join(' ')}>GBI</h5>
          <LinksGroup
            ...
            childrenLinks={[
              {
                header: '현황', link: '/app/main/analytics',
              },
              {
                header: '생성', link: '/app/forms/wizard',
              },
              {/*}
              {
                header: '분석', link: '/app/charts/highcharts',
              },
              {

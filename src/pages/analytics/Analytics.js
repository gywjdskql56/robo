...
class Analytics extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <h1 className="page-title">내 자산추이</h1>
        <div className={s.sidesWrapper}>
          <div className={s.analyticsSide}>
            <Row>
              ...
              <Col xs={12} xl={3} md={6}>
                <div className="pb-xlg h-100">
                  ...
                  >
                    ...
                    <h6 className="fs-sm text-muted">전체 기간 목표 대비</h6>
                    ...
                    <h6 className="mt fs-sm text-muted">현재까지의 기간 목표 대비</h6>
                      <Progress color="success" className="progress-sm" style={{height: '10px', marginBottom: '5px'}}
              ...
              <Col xs={12} md={6} xl={3} className={s.lastSideElement}>
              ...
              <Col xs={12} className="mb-lg">
                <Widget
                  className="pb-0"
                  bodyClass={`mt p-0`}
                  title={<h4><strong>포트폴리오 내역</strong></h4>}
                  close settings
                >
            ...
            <Row>
              ...
              <Col xs={12} md={6} xl={12} className={s.lastSideElement}>
                <Widget
                  ...
                  title={
                    <h4>개별 종목 주요 이슈<span className="badge rounded-pill bg-success fw-normal pull-right mt-1">{mock.notifications.length}</span></h4>
                  }
                >

...
export default {
  ...
  pie: {
    ...
    colors: [colors.default, colors.lawngreen, colors.blanchedalmond, colors.blue, colors.green, colors.orange, colors.red, colors.purple, colors.gray, colors.dark, colors.teal, colors.pink, colors.red, colors.Magenta, colors.firebrick],
    series: [{
      minPointSize: 10,
      innerSize: '20%',
      zMin: 0,
      name: 'countries',
      data: JSON.parse(sessionStorage.getItem("init_port"))[sessionStorage.getItem("risktype")].init_port
    }]
  },
  column3D: {
    credits: {
